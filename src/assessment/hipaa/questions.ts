...
export const hipaaAssessmentQuestions: PolicyAssessmentQuestion[] = [
  {
    ...
    message:
      'Did everyone in your organization receive Annual HIPAA Awareness Training?',
    default: false,
  },
  {
    type: 'confirm',
    ...
    message:
      'Did everyone in your organization receive at least annual training on the information security policies?',
    default: false,
  },
  {
    type: 'confirm',
    ...
    message:
      'Have you completed an annual Risk Assessment and documented the risks and action plans in a Risk Registry?',
    default: false,
  },
  {
    type: 'confirm',
    name: 'hasPenTestGap',
    message:
      'Have you completed at least one Penetration Test in the last year and documented the results and remediations?',
    default: false,
  },
  {
    type: 'input',
